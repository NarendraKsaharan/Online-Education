                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('courses') ? 'is-invalid' : '' }}" name="courses[]" id="courses" multiple>
                            @foreach($courses as $id => $course)
                                <option value="{{ $id }}" {{ (in_array($id, old('courses', [])) || $student->courses->contains($id)) ? 'selected' : '' }}>{{ $course }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        @foreach(App\Models\Student::GENDER_RADIO as $key => $label)
                            <div class="form-check form-check-inline form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}">
                                <input class="form-check-input ml-2" type="radio" id="gender_{{ $key }}" name="gender" value="{{ $key }}" {{ old('gender', $student->gender) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('join_date') ? 'is-invalid' : '' }}" type="text" name="join_date" id="join_date" value="{{ old('join_date', $student->join_date) }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('leave_date') ? 'is-invalid' : '' }}" type="text" name="leave_date" id="leave_date" value="{{ old('leave_date', $student->leave_date) }}">
