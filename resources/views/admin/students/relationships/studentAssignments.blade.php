    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-studentAssignments">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($assignments as $key => $assignment)
                            <tr data-entry-id="{{ $assignment->id }}">
                                ...
                                <td>
                                    @foreach($assignment->students as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-studentAssignments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
