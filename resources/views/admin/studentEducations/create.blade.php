...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.studentEducation.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.student-educations.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('university') ? 'is-invalid' : '' }}" name="university" id="university" required>{{ old('university') }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('passing_year') ? 'is-invalid' : '' }}" type="text" name="passing_year" id="passing_year" value="{{ old('passing_year') }}" required>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('percentage') ? 'is-invalid' : '' }}" type="text" name="percentage" id="percentage" value="{{ old('percentage', '') }}" required>
