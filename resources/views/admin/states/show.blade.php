...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#state_student_addresses" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="state_student_addresses">
            @includeIf('admin.states.relationships.stateStudentAddresses', ['studentAddresses' => $state->stateStudentAddresses])
        </div>
    </div>
</div>
