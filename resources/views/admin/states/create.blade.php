        ...
        <form method="POST" action="{{ route("admin.states.store") }}" enctype="multipart/form-data">
            ...
            <div class="add-more-table" style="width:100%">
                ...
                <table width="100%" style="border: 1px solid lightgrey;" id="state-table">
                    ...
                    <tr>
                        <td>
                            <input class="form-control" type="text" name="city_name[]" id="state_name" value="{{ old('city_name', '') }}" required>
                        </td>
                        <td>
                        ...
                        <td><input class="form-control add-row button" type="button" value="Add" ></td>
                    </tr>                                     
                </table>
            </div>
            <div class="form-group">
