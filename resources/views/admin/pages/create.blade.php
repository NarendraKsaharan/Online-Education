            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('meta_tag') ? 'is-invalid' : '' }}" type="text" name="meta_tag" id="meta_tag" value="{{ old('meta_tag', '') }}" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description" id="meta_description" required>{{ old('meta_description') }}</textarea>
