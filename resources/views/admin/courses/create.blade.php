                  ...
                  <div class="col-md-12">
                      <div class="table-responsive">
                          <table class="table table-bordered">
                              ...
                              <tr>
                              <td><input type="text" name="topic_title[]" value="{{ old('topic_title.' . $key) }}" class="form-control"></td>
                              <td>
                                  <select name="topic_status[]" class="form-control">
                                      <option value="1" {{ old('topic_status.' . $key) == 1 ? 'selected' : '' }}>Enable</option>
                                      <option value="2" {{ old('topic_status.' . $key) == 2 ? 'selected' : '' }}>Disable</option>
                                  </select>
                              </td>
                                <td><input type="button" value="ADD" class="form-control add-row button"></td>
                              </tr>
                          </table>
                      </div>
                  </div>
