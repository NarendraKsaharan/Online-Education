                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.fees.update", [$fee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $fee->amount) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remark" id="remark" required>{{ old('remark', $fee->remark) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="payment_date" id="payment_date" value="{{ old('payment_date', $fee->payment_date) }}" required>
