                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.students.update", [$student->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="join_date" id="join_date" value="{{ old('join_date', $student->join_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="leave_date" id="leave_date" value="{{ old('leave_date', $student->leave_date) }}">
