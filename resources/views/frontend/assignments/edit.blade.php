    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assignments.update", [$assignment->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $assignment->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="points" id="points" value="{{ old('points', $assignment->points) }}" step="1" required>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.assignments.storeCKEditorImages') }}', true);
...
Dropzone.options.imageDropzone = {
    url: '{{ route('frontend.assignments.storeMedia') }}',
    maxFilesize: 2, // MB
