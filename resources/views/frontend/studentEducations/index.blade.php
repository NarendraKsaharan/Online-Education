        ...
        <div class="col-md-12">
            @can('student_education_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.student-educations.create') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-StudentEducation">
                            <thead>
                                <tr>
                                    <th>
                                    ...
                                    <tr data-entry-id="{{ $studentEducation->id }}">
                                        ...
                                        <td>
                                            @can('student_education_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.student-educations.show', $studentEducation->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('student_education_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.student-educations.edit', $studentEducation->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('student_education_delete')
                                                <form action="{{ route('frontend.student-educations.destroy', $studentEducation->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('student_education_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.student-educations.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-StudentEducation:not(.ajaxTable)').DataTable({ buttons: dtButtons })
