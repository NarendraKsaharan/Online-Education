                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @else
                            ...
                            <li>
                                @can('exam_access')
                                    <a class="dropdown-item" href="{{ route('frontend.exams.index') }}">
                            ...
                            <li>  
                                @can('fee_record_access')
                                    <a class="dropdown-item" href="{{ route('frontend.fee-record') }}">
                            ...
                            <li>  
                                @can('course_video_access')
                                    <a class="dropdown-item" href="{{ route('frontend.course-videos.index') }}">
                            ...
                            <li> 
                                @can('assign_assignment_access')
                                    <a class="dropdown-item ml-3" href="{{ route('frontend.assign-assignments.index') }}">
                                        Assignments
                                    </a>
                                @endcan
                            </li> 
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('topic_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.topics.index') }}">
                                    ...
                                    @endcan
                                    @can('option_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.options.index') }}">
                                            {{ trans('cruds.option.title') }}
                                        </a>
                                    @endcan
                                    @can('exam_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.exams.index') }}">
                                            {{ trans('cruds.exam.title') }}
                                        </a>
                                    @endcan
                                    ...
                                    @endcan
                                    @can('fee_record_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.fee-records.index') }}">
                                            {{ trans('cruds.feeRecord.title') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('assignment_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.assignments.index') }}">
                                    ...
                                    @can('student_address_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.student-addresses.index') }}">
                                            {{ trans('cruds.studentAddress.title') }}
                                        </a>
                                    @endcan
                                    @can('student_education_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.student-educations.index') }}">
